                ...
                <div class="col-md-9">
                    ...
                    >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_en" value="{{ old('title_en', isset($faq) ?
                                $faq->title_en :
                             null) }}">
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="editor" rows="3">{{ old('description', isset($faq) ?
                            ...
                            ($faq) ?
                            $faq->description_en : null) }}</textarea>
                            </div>
