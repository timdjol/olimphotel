                    ...
                    >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="extra_place">Number of additional places</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="markup">Markup for extra space ($)</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cancelled">Cancellation cost ($)</label>
                                    <input type="number" name="cancelled" id="cancelled" value="{{ old('cancelled',
                                                                isset($room) ? $room->cancelled : null) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cancelled">Number of days until</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="include">Nutrition</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="bed" id="bed">
                                        ...
                                        @endif
                                        @endisset
                                        <option value="Двухместная">Double</option>
                                        <option value="Раздельная">Separate</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input id="tv" type="checkbox" name="services[]" value="Conventional oven"
                                    @isset($room)
                                        {{ in_array('Conventional oven', $services) ? 'checked' : '' }}
                                            @endisset>
                                    <label for="tv">Conventional oven</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status">
                                @if(isset($room))
                                    @if($room->status == 1)
                                        <option value="{{$room->status}}">Active</option>
                                        <option value="0">Disable</option>
                                    @else
                                        <option value="{{$room->status}}">Disable</option>
