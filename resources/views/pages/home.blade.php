                        ...
                        <div class="form-group">
                            ...
                            <select name="title" id="hotel">
                                ...
                                @foreach($hotels as $hotel)
                                    ...
                                    }}">{{ $hotel->__('title')}} {{ $hotel->__('address') }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="rating" id="rating">
                                <option value="">@lang('main.choose')</option>
                                <option value="2"><img src="{{route('index')}}/img/star.svg"></option>
                                <option value="3">3</option>
                                <option value="4">4</option>
                                <option value="5"><i class="fa">&#xf005;</i><i class="fa">&#xf005;</i><i class="fa">&#xf005;</i><i
                                            class="fa">&#xf005;</i><i class="fa">&#xf005;</i></option>
                            </select>
